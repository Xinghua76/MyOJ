...
/* tslint:disable */
/* eslint-disable */
import type { DeleteBatchRequest } from '../models/DeleteBatchRequest';
import type { DeleteRequest } from '../models/DeleteRequest';
import type { Page_Question_ } from '../models/Page_Question_';
import type { Page_QuestionSubmitVO_ } from '../models/Page_QuestionSubmitVO_';
import type { Page_QuestionVO_ } from '../models/Page_QuestionVO_';
...
export class QuestionControllerService {
     ...
     * @throws ApiError
     */
    public static deleteBatchQuestionsUsingPost(
        deleteBatchRequest: DeleteBatchRequest,
    ): CancelablePromise<BaseResponse_boolean_> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/question/delete/batch',
